...
- Added a note to the README that the implementation of Fukushima's method is
 ...
 [this compiler explorer link](https://godbolt.org/#g:!((g:!((g:!((h:codeEditor,i:(filename:'1',fontScale:14,fontUsePx:'0',j:1,lang:rust,selection:(endColumn:79,endLineNumber:65,positionColumn:79,positionLineNumber:65,selectionStartColumn:79,selectionStartLineNumber:65,startColumn:79,startLineNumber:65),source:'///+zc+%3D+z+%2B+1/e%0Afn+dw0c(zc:+f64)+-%3E+f64+%7B%0A++++if+zc+%3C+0.0+%7B%0A++++++++f64::NAN%0A++++%7D+else+if+zc+%3C%3D+1.412_707_514_527_465_2e104+%7B%0A++++++++//+I!'ve+avoided+putting+all+the+other+branches+into+the+example+link+in+order+to+not+make+it+so+large.%0A++++++++//+The+remaining+branch+is+the+most+complicated+branch+of+the+50+bit+approximation+of+W_0+though,%0A++++++++//+as+it+utilizes+the+natural+logarithm+of+the+input.%0A++++++++unimplemented!!()%3B%0A++++%7D+else+if+zc+%3C+f64::INFINITY+%7B%0A++++++++rational_function(%0A++++++++++++zc.ln(),%0A++++++++++++%5B%0A++++++++++++++++-0.615_144_128_127_297_6,%0A++++++++++++++++0.679_793_101_336_309_3,%0A++++++++++++++++0.089_685_353_704_585_82,%0A++++++++++++++++0.001_564_494_148_398_938,%0A++++++++++++++++7.734_990_187_817_636e-6,%0A++++++++++++++++1.289_164_754_669_943_5e-8,%0A++++++++++++++++7.089_032_598_897_381_6e-12,%0A++++++++++++++++9.841_979_033_427_972e-16,%0A++++++++++++%5D,%0A++++++++++++%5B%0A++++++++++++++++1.,%0A++++++++++++++++0.097_300_263_710_401_44,%0A++++++++++++++++0.001_610_367_274_844_206,%0A++++++++++++++++7.824_774_100_307_7e-6,%0A++++++++++++++++1.294_926_130_897_134_6e-8,%0A++++++++++++++++7.098_691_121_934_283e-12,%0A++++++++++++++++9.842_628_504_222_704e-16,%0A++++++++++++++++-1.596_014_725_260_605_6e-24,%0A++++++++++++%5D,%0A++++++++)%0A++++%7D+else+%7B%0A++++++++f64::INFINITY%0A++++%7D%0A%7D%0A%0Afn+rational_function%3Cconst+N:+usize,+const+D:+usize%3E(%0A++++x:+f64,%0A++++numerator_coefficients:+%5Bf64%3B+N%5D,%0A++++denominator_coefficients:+%5Bf64%3B+D%5D,%0A)+-%3E+f64+%7B%0A++++let+numerator+%3D+numerator_coefficients%0A++++++++.into_iter()%0A++++++++.rev()%0A++++++++.fold(0.0,+%7Csum,+coeff%7C+sum+*+x+%2B+coeff)%3B%0A++++++++%0A++++let+denominator+%3D+denominator_coefficients%0A++++++++.into_iter()%0A++++++++.rev()%0A++++++++.fold(0.0,+%7Csum,+coeff%7C+sum+*+x+%2B+coeff)%3B%0A%0A++++numerator+/+denominator%0A%7D%0A%0Afn+lambert_w0(z:+f64)+-%3E+f64+%7B%0A++++dw0c(z+%2B+1.0+/+core::f64::consts::E)%0A%7D%0A%0A//+Should+be+702.534870674876719+according+to%0A//+https://www.wolframalpha.com/input%3Fi%3DLambertW%255B0%252C%2B%25281-1%252F2%255E%252864-10-1%2529%2529*2%255E%25282%255E10%2529%252F2%255D%0A//+and+it+is+702.53487067487674.%0A//+At+least+that+is+what+you+get+if+you+convert+the+hex+data+in+the+%0A//+.quad+constant+at+.LCPI0_0+in+the+output+window+to+a+floating+point+number.%0Apub+fn+const_eval_example()+-%3E+f64+%7B%0A++++lambert_w0(f64::MAX+/+2.0)%0A%7D%0A'),l:'5',n:'0',o:'Rust+source+%231',t:'0')),k:50.00075309447186,l:'4',n:'0',o:'',s:0,t:'0'),(g:!((h:compiler,i:(compiler:r1860,filters:(b:'0',binary:'1',binaryObject:'1',commentOnly:'0',debugCalls:'1',demangle:'0',directives:'0',execute:'1',intel:'0',libraryCode:'0',trim:'1',verboseDemangling:'0'),flagsViewOpen:'1',fontScale:14,fontUsePx:'0',j:2,lang:rust,libs:!(),options:'-C+opt-level%3D3',overrides:!((name:edition,value:'2021'),(name:arch,value:x86_64-unknown-linux-gnu)),paneName:'x86_64-uknown-linux-gnu+(rustc+1.83.0)',selection:(endColumn:1,endLineNumber:1,positionColumn:1,positionLineNumber:1,selectionStartColumn:1,selectionStartLineNumber:1,startColumn:1,startLineNumber:1),source:1),l:'5',n:'0',o:'x86_64-uknown-linux-gnu+(rustc+1.83.0)',t:'0')),header:(),k:49.99924690552815,l:'4',n:'0',o:'',s:0,t:'0')),l:'2',n:'0',o:'',t:'0')),version:4).
