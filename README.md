...
This method does not allocate, recourse, or iterate, and both it's time and space complexities are O(1).
The method works by dividing the function's domain into subdomains.
