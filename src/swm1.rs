...
pub fn swm1(z: f64) -> f64 {
    if z < NEG_INV_E {
        ...
        rational_function(
            ln(-z),
            [
                -3.3108760911710447554,
                1.0500678809935174775,
                -0.0082367495821343204940,
                5.5289561594910188441e-6,
            ],
            [
                1.0,
                -0.0081892727433315511867,
                5.5280076009711954032e-6,
                -3.9222773084574060594e-14,
            ],
        )
    } else {
        f64::NAN
