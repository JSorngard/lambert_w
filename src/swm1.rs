#[rustfmt::skip]
const TABLE: [(f64, [f64; 4], [f64; 4]); 10] = [
    // W >= -2.483, Y_-1
    (-0.207_293_777_640_384_15, [
...
pub fn swm1(z: f64) -> f64 {
    ...
    let x = if z <= -0.000_074_906_612_036_101_44 {
