...
pub fn swm1(z: f64) -> f64 {
    if z < Z0 {
        ...
        pade_3(
            ...
            [1.0, 24.2958369518787, 64.112460611386, 17.9944973690393],
        )
    } else if z <= -0.071_507_705_083_841_95 {
        // W >= -4.032, Y_-2
        ...
        pade_3(
            ...
            [1.0, 77.6812425889974, 648.564312140752, 566.701549764362],
        )
    } else if z <= -0.020_704_412_621_717_48 {
        // W >= -5.600, Y_-3
        ...
        pade_3(
            ...
            [1.0, 272.37526135124, 7929.22426129135, 23980.1228608213],
        )
    } else if z <= -0.005_480_012_945_209_444 {
        // W >= -7.178, Y_-4
        ...
        pade_3(
            ...
            [1.0, 1021.79385660668, 111300.229154865, 1261425.64000884],
        )
    } else if z <= -0.001_367_466_989_250_804_2 {
        // W >= -8.766, Y_-5
        ...
        pade_3(
            ...
            [1.0, 4044.97530648807, 1741827.761903, 78436907.3808069],
        )
    } else if z <= -0.000_326_142_267_310_725_66 {
        // W >= -10.367, Y_-6
        ...
        pade_3(
            ...
            [1.0, 16743.8266077371, 29809650.9460117, 5573951481.6958],
        )
    } else if z <= -0.000_074_906_612_036_101_44 {
        // W >= -11.983, Y_-7
        ...
        pade_3(
            ...
            [1.0, 72009.2555252101, 550590076.718758, 443248948670.003],
        )
    } else if z <= -1.096_244_452_641_099_5e-19 {
        // W >= -47.518, V_-8
        ...
        pade_3(
            ...
            [
                ...
                1.28192696399805,
                -0.0749793561138123,
                0.000476363091620691,
            ],
            [
                1.0,
                -0.0720008737238687,
                0.00047548932989597,
                -4.17149792475468e-10,
            ],
        )
    } else if z < 0.0 {
        // V_-10
