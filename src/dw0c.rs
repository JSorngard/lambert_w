const TABLE: [(f64, [f64; 9], [f64; 9]); 19] = [
    // W <= 0.893, X_1
    (
        2.549_893_906_503_473_6,
        [
...
pub fn dw0c(zc: f64) -> f64 {
    ...
    let x = if zc <= 3.968_539_219_834_401_6e19 {
        zc.sqrt()
    } else {
        zc.ln()
    };
