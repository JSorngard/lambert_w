#[rustfmt::skip]
const TABLE: [(f64, [f64; 8], [f64; 8]); 11] = [
    // W >= -1.3, X_-1
    (-0.3542913309442164, [
...
pub fn dwm1c(z: f64) -> f64 {
    if !(NEG_INV_E..0.0).contains(&z) {
        return f64::NAN;
    }
    ...
    let x = if z <= -0.000_077_447_159_838_062_18 {
        let x = (z - NEG_INV_E).sqrt();
