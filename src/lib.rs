...
#[cfg(feature = "24bits")]
/// Same as [`sp_lambert_w0`] but calculated on `f32` instead of `f64`
///
/// This results in slightly reduced accuracy.
...
#[cfg(feature = "24bits")]
/// Same as [`sp_lambert_wm1`], but calculated on `f32` instead of `f64`.
///
/// This results in slightly reduced accuracy.
