...
///
/// Uses the same 24-bit accurate approximation as [`sp_lambert_w0`] but evaluating it on `f32`
...
///
/// Uses the same 24-bit accurate approximation as [`sp_lambert_wm1`] but evaluating it on `f32`
/// results in slightly reduced accuracy.
///
/// # Examples
///
