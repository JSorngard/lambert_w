...
mod tets {
    ...
    #[test]
    fn test_lambert_wm1_24() {
        assert_abs_diff_eq!(
            lambert_wm1_24(-3.578794411714423e-01).unwrap(),
            -1.253493791367214,
            epsilon = 1e-7
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-2.678794411714424e-01).unwrap(),
            -2.020625228775403,
            epsilon = 1e-7
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000000e-01).unwrap(),
            -3.577152063957297,
            epsilon = 1e-9
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-3.000000000000000e-02).unwrap(),
            -5.144482721515681,
            epsilon = 1e-9
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000000e-02).unwrap(),
            -6.472775124394005,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-3.000000000000000e-03).unwrap(),
            -7.872521380098709,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000000e-03).unwrap(),
            -9.118006470402742,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-3.000000000000001e-04).unwrap(),
            -1.045921112040100e+01,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000000e-04).unwrap(),
            -1.166711453256636e+01,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-3.000000000000000e-05).unwrap(),
            -1.297753279184081e+01,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000000e-05).unwrap(),
            -1.416360081581018e+01,
            epsilon = 1e-6
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000004e-75).unwrap(),
            -1.778749628219512e+02,
            epsilon = 1e-5
        );
        assert_abs_diff_eq!(
            lambert_wm1_24(-1.000000000000008e-145).unwrap(),
            -3.397029099254290e+02,
            epsilon = 1e-4
        );
    }
