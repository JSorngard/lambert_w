...
//! It is implemented in code as conditional switches on the input value followed by either a square root (and possibly a division) or a logarithm and finished by a series of multiplications and additions by fixed constants.
//!
...
/// -1/e = 0.6065306597126334. The smallest input value for which the Lambert W functions in this crate return a value.
