...
pub fn sw0(z: f64) -> f64 {
    if z < NEG_INV_E || z.is_nan() {
        ...
        rational_function(
            ln(z),
            [
                -3.1320056028863661192,
                0.94889465726532600902,
                0.0083178152961644393217,
                5.5587848157833492890e-6,
            ],
            [
                1.0,
                0.0083656818677730058769,
                5.5597154935973275364e-6,
                -3.7481535833151202222e-14,
            ],
        )
    } else {
        f64::INFINITY
