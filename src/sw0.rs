...
pub fn sp_lambert_w0(z: f64) -> f64 {
    ...
    if z < NEG_INV_E {
        ...
        if z <= 4_705.918_954_265_969_037_7 {
            if z <= 30.539_142_109_510_895_244 {
                if z <= 2.008_217_811_584_472_656_3 {
                    // W <= 0.854, X_1
                ...
                if z <= 371.669_843_713_757_760_70 {
                    // W <= 4.430, X_3
            ...
            if z <= 965_649.030_871_163_226_41 {
                if z <= 64_640.797_355_310_089_675 {
                    // W <= 8.892, X_5
        ...
        if z <= 4.407_744_425_147_793_893_9e13 {
            if z <= 9.791_115_441_672_696_027_7e10 {
                // W <= 22.207, X_10
            ...
            if z <= 1.004_838_215_057_150_448_5e15 {
                // W <= 31.106, X_13
        ...
        if z <= 1.532_693_858_990_176_659_2e19 {
            if z <= 5.939_799_659_746_575_434_6e17 {
                // W <= 37.306, X_15
        ...
        if z <= 2.172_370_661_049_060_431_7e141 {
            // W <= 319.673, U_18
